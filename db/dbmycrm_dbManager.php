...
function getConnection() {
	...
	global $db_mycrm_db_Url, $db_mycrm_db_User, $db_mycrm_db_Pass, $db_mycrm_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_mycrm_db_Url.";dbname=".$db_mycrm_db_DbName, $db_mycrm_db_User, $db_mycrm_db_Pass);
